  ...
  return (
    <div className="App bg-background">
      ...
      <main className="page-width">
        <section id="hero" className="bottom-0 z-50 flex w-full items-center justify-between border-t border-black/10 p-20 text-slate-100">
        ...
        <div id="projets" className="mx-auto max-w-2xl space-y-6 p-8 text-lg leading-relaxed text-main-text ">
